...
# # class Application(models.Model):    asubuhi
# #     researcher = models.ForeignKey(User, on_delete=models.CASCADE, related_name='applications')
# #     title = models.CharField(max_length=300)
# #     category = models.CharField(max_length=100)
# #     research_type = models.CharField(   # 👈 ongeza hii
# #         max_length=100,
# #         choices=[
# #             ('Environment & Marine', 'Environment & Marine'),
# #             ('Aquatic Organisms', 'Aquatic Organisms'),
...
#         null=True
#     )
#     year = models.IntegerField(blank=True, null=True)   # ✅ imeongezwa
#     start_date = models.DateField()
#     end_date = models.DateField()
#     description = models.TextField(blank=True, null=True)   # ✅ imeongezwa
#     objectives = models.TextField(blank=True, null=True)    # ✅ imeongezwa
#     methodology = models.TextField(blank=True, null=True)   # ✅ imeongezwa
#     expected_outcomes = models.TextField(blank=True, null=True)  # ✅ imeongezwa
...
# class Attachment(models.Model):
#     application = models.ForeignKey(
#         'Application',  # assuming Application is defined in the same app
#         on_delete=models.CASCADE,
#         related_name='attachments'
#     )
#     file_type = models.CharField(
...
#     def save(self, *args, **kwargs):
#         if self.file_path:
#             self.original_filename = self.file_path.name.split('/')[-1]  # gets actual filename
#             self.file_size = self.file_path.size
#         super().save(*args, **kwargs)
...
class Payment(models.Model):
    ...
    def calculate_fee(self):
        return 100000  # default fee, adjust as needed
